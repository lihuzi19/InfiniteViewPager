...
public abstract class WholePictureDisplayAdapter extends PagerAdapter {
    ...
    public void setInfinite(boolean infinite) {
        ...
        setViewPager().post(new Runnable() {
            @Override
            public void run() {
    ...
    private ArrayList<View> _viewHolderList;
    private int _childCount = 0;//PagerAdapter刷新机制有问题，需要重写notifyDataSetChanged和getItemPosition方法
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        _viewHolderList.add(((View) object));
    }
